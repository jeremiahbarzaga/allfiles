...
<div class="nav">
    <nav>
      ...
      <li><a  href="../Lingap-Bata-Patag/home/home1.html" target="_self">Home</a></li>
        ...
        <li><a  href="../Lingap-Bata-Patag/clientschedule.php">Book A Visit</a></li>
        <li><a class="active" href="../Lingap-Bata-Patag/clientlivelihood.php" target="_self">Livelihood</a></li>
        </ul>
    </nav>
  </div>
    ...
    <h1 class="news">LIVELIHOOD</h1>

    <?php 
       require_once("../admin/connectiondb.php");

        $checkingtittles = "select * from livelihooddata ORDER BY Id DESC ";
        ...
        while($rows = $data->fetch_assoc())
        {
            ...
            <div class="image">
            <?php
            $checkingimagetittles = "select * from liveimage where tittle = '$tittle' ";
    ...
    ?>
    <h1 class="nomorenews">No More Available Livelihood</h1>
