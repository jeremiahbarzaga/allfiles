...
{   $tittle = $_POST['tittle'];
  $description = $_POST['description'];
      ...
      $description = $_POST['description'];
            ...
            {
                echo  header("location:addlivelihood.php?msg=error");
            }    
            else{
        ...
        for($i = 0;$i<$imagecount;$i++)
        {
            ...
            $result = mysqli_query($con,$insertingimagequery);
                ...
                echo  header("location:addlivelihood.php?msg=success");
...
<div class="nav">
    ...
    <div class="formdesign">
       ...
       <form action="" method="post" enctype="multipart/form-data">
            ...
            <br>
            <input type="submit" name="submit"  value="Upload To Livelihood" id="submit"> 
