...
$checkingtittles = "select * from livelihooddata where tittle = '$newstittle' ";
    ...
    {   $tittle = $_POST['tittle'];
      $description = $_POST['description'];
        ...
        if($ID != ""){
          ...
          $query1 = "Update livelihooddata set tittle = '$tittle', description = '$description' where Id = '$ID'";
          $data1 = $con->query($query1) or die ($con->error);

          $query = "Delete from liveimage where tittle = '$newstittle'";
          ...
          for($i = 0;$i<$imagecount;$i++)
          {
              ...
              {
                  $query2 = "INSERT INTO `liveimage`(`tittle`, `img_dir`) VALUES ('$tittle','$targetpath')";
                  $data2 = $con->query($query2) or die ($con->error);
          ...
          $description = $_POST['description'];
                ...
                $checkingtittles = "select * from livelihooddata where tittle = '$tittle' ";
                $data = $con->query($checkingtittles) or die ($con->error);
                $rows = $data->fetch_assoc();
                ...
                $query = "INSERT INTO `livelihooddata`( `tittle`, `description`) VALUES ('$tittle','$description')";
                $data = $con->query($query) or die ($con->error);
            ...
            for($i = 0;$i<$imagecount;$i++)
            {
                ...
                if(move_uploaded_file($imagetempname,$targetpath))
                {
                    $query = "INSERT INTO `liveimage`(`tittle`, `img_dir`) VALUES ('$tittle','$targetpath')";
                    $data = $con->query($query) or die ($con->error);
...
<div class="nav">
    ...
    <div class="formdesign">
       ...
       <form action="" method="post" enctype="multipart/form-data">
            ...
            <div>
            <input type="text" name="tittle" id="tittle" placeholder="Tittle :" value="<?php  echo $newstittle;?>" required>
            
            <textarea name="description" placeholder="Description:" id="description"  ><?php echo $des;?></textarea>
