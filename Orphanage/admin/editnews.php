...
$checkingtittles = "select * from newsdata where tittle = '$newstittle' ";
    ...
    {   $tittle = $_POST['tittle'];
      $description = $_POST['description'];
        ...
        if($ID != ""){
          ...
          $query1 = "Update newsdata set tittle = '$tittle', description = '$description' where Id = '$ID'";
          $data1 = $con->query($query1) or die ($con->error);

          $query = "Delete from newsimage where tittle = '$newstittle'";
          ...
          for($i = 0;$i<$imagecount;$i++)
          {
              ...
              {
                  $query2 = "INSERT INTO `newsimage`(`tittle`, `img_dir`) VALUES ('$tittle','$targetpath')";
