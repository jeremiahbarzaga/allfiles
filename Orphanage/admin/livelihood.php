          ...
          <?php 
              ...
              while($rows = $data->fetch_assoc())
              {
                  ...
                  ?> 
                    ...
                    <h5><?php echo " <a href=editlivelihood.php?id=$ID&tittles=$tittle&descriptions=$description >Edit</a>"?></h5>
                    <h5><?php echo " <a href=deletelive.php?id=$ID&tittles=$tittle >Delete</a>"?></h5>
